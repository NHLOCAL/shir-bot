...
def download_mp3(media_url, desired_filename=None):
    ...
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36 Edg/123.0.0.0'} # בדוק גרסאות עדכניות אם חשוב
