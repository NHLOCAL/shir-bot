...
const footerContent = [
  "<b>↩ שימו לב!</b> הודעת ההורדה ירדה למטה - כעת תוכלו לראות את התקדמות ההורדה ממש כאן <b>↗↗↗</b>",
  "<b>ביט פלוס-הבית של המוזיקאים!</b> אנחנו מציעים מגוון רחב של כלי נגינה | מקצבים | הגברה | מדריכים למוזיקה <a id='beatplus' href='https://beatplus.co.il/?utm_source=nhlocal.github.io/shir-bot/' target='_blank'>עברו לאתר</a>",
...
document.querySelector('#beatplus').addEventListener('click', function() {
gtag('event', 'ad_click', {
  'event_category': 'Ads',
